      ...
      <div class="container">
                ...
                @forelse ($carts as $cart)
                  <tr>
                    ...
                    <td style="width: 32.5%">
                      ...
                      <div class="product-subtitle">by {{ $cart->product->user->store_name ? $cart->product->user->store_name : $cart->product->user->name }}</div>
                    </td>
                    <td style="width: 32.5%">
        ...
        @csrf
          ...
          <div class="row" data-aos="fade-up" data-aos-delay="250">
            ...
            <div class="col-12">
              <div class="mb-2">Payment Informations</div>
            </div>
          </div>
    ...
    <script>
      var locations = new Vue({
        ...
        data: {
          provinces: null,
          regencies: null,
          provinces_id: {{ $cart->user->provinces_id ? $cart->user->provinces_id : 0 }},
          regencies_id: {{ $cart->user->regencies_id ? $cart->user->regencies_id : 0 }},
        },
        methods: {
          getProvinces() {
            var self = this;
